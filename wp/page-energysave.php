<?php 
/*
Template Name: ソーラーカーポートの導入により電気代削減が可能です
Template Post Type: page
*/
get_header(); ?>

<main class="energysave">
  <section class="hero">
    <div class="containers flex jcC">
      <ul class="flex hero__cat">
        <li class="cat">近年の電気代高騰にお困りの企業様へ</li>
      </ul>
      <h1 class="hero__lead cB"><em>ソーラーカーポート</em>の導入により<br class="sp-only"><em>電気代削減</em>が可能です</h1>
      <div class="hero__btn">
        <div class="ctabtn">
  ...
  <section class="product">
    <div class="containers">
      ...
      <ul class="flex jcA item">
        <li class="item__box">
          <img src="<?php echo assets_path() ?>img/top/before.png" alt="従来の太陽光発電">
        </li>
        <li class="item__box">
          <img src="<?php echo assets_path() ?>img/pages/after.png" alt="ソーラーカーポート">
        </li>
      </ul>
    </div>
  </section>
    ...
    <div class="containers">
      ...
      <ul class="flex gap20 card">
        <li class="card__box">
          ...
          <h3 class="card__box--ttl">工期が短い</h3>
          <div class="card__box--txt">コンクリート基礎が不要な工法のため、大幅に工期を短縮できます。</div>
        </li>
        <li class="card__box">
          <figure class="card__box--img"><img src="<?php echo assets_path() ?>img/top/icon02.svg" alt="フレキシビリティ"></figure>
          <h3 class="card__box--ttl">フレキシビリティ</h3>
        ...
        <li class="card__box">
          ...
          <h3 class="card__box--ttl">レイアウトの自由度</h3>
  ...
  <section class="hojo">
    <div class="containers">
      <h2 class="ttl-secondary cB">「税制優遇」や「補助金」が活用できる場合があります。</h2>
      <div class="lead">太陽光発電の導入にあたり、「中小企業経営強化税制」による優遇を受けられたり、地方自治体様によっては「補助金」が<br class="pc-only">活用できるケースもあり、有効活用することで、導入費用の負担を低減できます。</div>
      <div class="flex aiC jcC desc">
        <figure class="desc__img"><img src="<?php echo assets_path() ?>img/pages/img-energysave03.png" alt="ソーラーカーボードの導入費用"></figure>
        <summary class="desc__box">
          <span class="caution">※税制優遇や補助金には適用期間が設けられています。詳しくは<a href="<?php echo esc_url( home_url( '/' ) ); ?>contact/">お問い合わせ</a>ください。</span>
        </summary>
      </div>
    </div>
  </section>
