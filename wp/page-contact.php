...
<main class="contact">
  ...
  <section class="form">
    <div class="containers">
      ...
      <!-- <form action="">
        <div class="form__ttl">ご問合せ・簡易見積り依頼フォーム</div>
        <div class="form__table">
          ...
          <button type="submit" class="more bgG">確認画面へ進む</button>
        </div>
      </form> -->

      

      <script id='formScript3156000001270014' src='https://crm.zoho.jp/crm/WebFormServeServlet?rid=22589cb194e0c5d9287e84f262d3a1cb0ee457b42cdfce44235754373e9bd389gidcf021c2a4ad48dad996676aa48e763b1d074fc1c1ba203551ca521c2ff197cbb&script=$sYG'></script>
